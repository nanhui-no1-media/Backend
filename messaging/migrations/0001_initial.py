    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversation_type', models.CharField(choices=[('task', '任务讨论'), ('private', '私人对话'), ('proposal', '申报讨论')], max_length=10, verbose_name='类型')),
                ...
                ('proposal', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='conversations', to='proposals.proposal', verbose_name='关联申报')),
